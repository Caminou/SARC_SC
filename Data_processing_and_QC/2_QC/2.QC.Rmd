...
```{r plot_Gruel_quantiles, fig.width=15, fig.height=15, warning=FALSE}
...
```{r get_quantiles_SARC, fig.width=15, fig.height=15, warning=FALSE}
library(dplyr)
...
```{r plot_SARC_quantiles, fig.width=15, fig.height=15, warning=FALSE}
# Violin plot for nCount_RNA with color coding for outliers
...
```{r, fig.width=10, fig.width=15, fig.height=15, warning=FALSE}
SARC@meta.data %>%
