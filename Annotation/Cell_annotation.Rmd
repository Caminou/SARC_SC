...
```{r}
ASPC$cell_type=ASPC$harmony_cluster.0.6

# Map the cluster IDs to the new cell type annotations
cell_type = c(
  "0"="ASPC", "1"="ASPC", "2"="ASPC", "3"="ASPC", "4"="ASPC_C1QA",
  "5"="ASPC", "6"="ASPC", "7"="ASPC", "8"="ASPC", "9"="ASPC",
  "10"="ASPC", "11"="ASPC", "12"="ASPC", "13"="ASPC", "14"="ASPC",
  "15"="ASPC_prolif", "16"="ASPC", "17"="ASPC", "18"="ASPC",
  "19"="ASPC_preadipocyte", # APOE
  "20"="remove", "21"="ASPC", "22"="ASPC", "23"="remove",
  "24"="ASPC", "25"="ASPC", "26"="ASPC", "27"="ASPC", "28"="ASPC",
  "29"="ASPC", "30"="Mesothelial", "31"="ASPC", "32"="ASPC",
  "33"="ASPC", "34"="remove", "35"="remove", "36"="ASPC"
)
...
```{r}
Tcell$cell_type=Tcell$harmony_cluster.1.2

# Map the cluster IDs to the new cell type annotations
cell_type = c(
  "0"="Tcell_CD4_helper", "1"="Tcell", "2"="Tcell_CD4_helper", "3"="Tcell", "4"="Tcell_CD8_effector",
  "5"="Tcell_CD4_Treg", "6"="Tcell_CD8_effector", "7"="Tcell_CD8_effector", "8"="NK", "9"="Tcell_Cd8_cytotoxic",
  "10"="Tcell_CD4_helper", "11"="NK", "12"="Tcell", "13"="NK", "14"="Tcell",
  "15"="NK", "16"="Tcell_CD4_effector","17"="remove","18"="Tcell_CD4_Treg","19"="Tcell_CD4_helper","20"="Tcell_CD8_effector","21"="NK","22"="Tcell_CD8_effector","23"="Tcell","24"="Tcell_Cd8_cytotoxic","25"="remove")
...
Merge_data$cell_type[is.na(Merge_data$cell_type)] <- "remove"
